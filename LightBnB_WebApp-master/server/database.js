 ...
 * @return {Promise<[{}]>} A promise to the reservations.email
 */
...
const addProperty = function(property) {
  ...
  INSERT INTO properties (
    owner_id, title, description, cover_photo_url, thumbnail_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, province, city, country, street, post_code) 
